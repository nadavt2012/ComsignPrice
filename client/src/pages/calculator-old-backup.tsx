...
export default function Calculator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 p-3 sm:p-4 lg:p-6" dir="rtl" lang="he" style={{fontFamily: 'Inter, system-ui, -apple-system, sans-serif', direction: 'rtl', textAlign: 'right', unicodeBidi: 'embed'}}>
      <div className="flex flex-col min-h-screen">
        <Card className="w-full max-w-md mx-auto shadow-2xl bg-white border-gray-200 border-2 rounded-2xl" dir="rtl" style={{direction: 'rtl', textAlign: 'right', unicodeBidi: 'embed'}}>
          <CardContent className="p-4 space-y-6" dir="rtl" style={{direction: 'rtl', textAlign: 'right'}}>
            {/* Header Section */}
            <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label className="text-sm font-semibold text-gray-700 mb-2 block text-right" dir="rtl" style={{direction: 'rtl', textAlign: 'right'}} data-testid="label-project-type">
                  <div className="flex items-center gap-2 justify-start">
                ...
                <Select value={projectType} onValueChange={setProjectType} dir="rtl">
                  <SelectTrigger className="w-full p-3 border-2 border-gray-300 bg-white text-gray-900 hover:border-gray-400 text-base focus:border-gray-500 min-h-[50px]" dir="rtl" style={{direction: 'rtl', textAlign: 'right'}} data-testid="select-project-type">
                    <SelectValue placeholder="בחר סוג פרויקט" className="text-base text-gray-900" dir="rtl" style={{direction: 'rtl', color: '#111827'}} />
                  </SelectTrigger>
                  <SelectContent>
              ...
              {/* Years Selection */}
              <div>
                <Label className="text-sm font-semibold text-gray-700 mb-2 block text-right" dir="rtl" style={{direction: 'rtl', textAlign: 'right'}} data-testid="label-years">
                  <div className="flex items-center gap-2 justify-start">
                    <span>כמות שנים</span>
                ...
                <Select value={years} onValueChange={setYears} disabled={!projectType} dir="rtl">
                  <SelectTrigger className="w-full p-3 border-2 border-gray-300 text-base focus:border-gray-500 hover:border-gray-400 disabled:bg-white disabled:text-gray-900 disabled:border-gray-300 disabled:opacity-100 bg-white text-gray-900 min-h-[50px]" dir="rtl" style={{direction: 'rtl', textAlign: 'right'}} data-testid="select-years">
                    <SelectValue placeholder="בחר כמות שנים" className="text-base text-gray-900" dir="rtl" style={{direction: 'rtl', color: '#111827'}} />
                </SelectTrigger>
                <SelectContent>
              ...
              <div>
                <Label className="text-sm font-semibold text-gray-700 mb-2 block text-right" dir="rtl" style={{direction: 'rtl', textAlign: 'right'}} data-testid="label-certificates">
                  <div className="flex items-center gap-2 justify-start">
              ...
              {/* Backup Certificates */}
              <div>
                <Label className="text-sm font-semibold text-gray-700 mb-2 block text-right" dir="rtl" style={{direction: 'rtl', textAlign: 'right'}} data-testid="label-backup-certificates">
                  <div className="flex items-center gap-2 justify-start">
